...
NS_LOG_COMPONENT_DEFINE ("inter-cluster");
...
//1-5,6-2,3-7,8-4
  ...
  int16_t sinkPort = 24;
/*
  PacketSinkHelper packetSinkHelper_1("ns3::TcpSocketFactory",InetSocketAddress(csmaInterfaces_5.GetAddress(1),sinkPort));
  PacketSinkHelper packetSinkHelper_2("ns3::TcpSocketFactory",InetSocketAddress(csmaInterfaces_3.GetAddress(2),sinkPort));
  PacketSinkHelper packetSinkHelper_3("ns3::TcpSocketFactory",InetSocketAddress(csmaInterfaces_6.GetAddress(1),sinkPort));
  PacketSinkHelper packetSinkHelper_4("ns3::TcpSocketFactory",InetSocketAddress(csmaInterfaces_4.GetAddress(2),sinkPort));
  ApplicationContainer sinkApp_1 = packetSinkHelper_1.Install(csmaNodes_5.Get(1));
  ApplicationContainer sinkApp_2 = packetSinkHelper_2.Install(csmaNodes_3.Get(2));
  ApplicationContainer sinkApp_3 = packetSinkHelper_3.Install(csmaNodes_6.Get(1));
  ApplicationContainer sinkApp_4 = packetSinkHelper_4.Install(csmaNodes_4.Get(2));
...
*/
  ...
  OnOffHelper client_1("ns3::TcpSocketFactory", InetSocketAddress(csmaInterfaces_5.GetAddress (1), sinkPort));
  ...
  OnOffHelper client_2("ns3::TcpSocketFactory", InetSocketAddress(csmaInterfaces_3.GetAddress (2), sinkPort));
  ...
  OnOffHelper client_3("ns3::TcpSocketFactory", InetSocketAddress(csmaInterfaces_6.GetAddress (1), sinkPort));
  ...
  OnOffHelper client_4("ns3::TcpSocketFactory", InetSocketAddress(csmaInterfaces_4.GetAddress (2), sinkPort));
...
//抓包在端口192.168.1.1(c1)，10.1.2.1(a2)，10.0.4.1(t4) 
  pointToPoint.EnablePcap ("inter", p2pDevices_1.Get (0), true); 
  csma.EnablePcap ("inter", csmaDevices_2.Get (0), true);
  csma.EnablePcap ("inter", csmaDevices_6.Get (0), true);
